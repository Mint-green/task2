        ...
        if (res3.status == 200) {
            ...
            if (res3result.errcode === 0) {
                document.getElementById("login").innerHTML =
                    ...
                    "<label><button id='logout' style='border: solid 1px' onclick='logoutfunction()'>注销</button>";
            }
        }
    }
}
...
function changefunction() {
    ...
    var request = new XMLHttpRequest();
    request.open('POST', 'vertify.php', true);
    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    request.send();
    request.onreadystatechange = function(){
...
function logoutfunction() {
    ...
    res.open("POST", "deletesession.php");
    res.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    res.send();

    document.getElementById('login').innerHTML = '想要留言吗，快<a href="../123.html">登录</a> 吧';
